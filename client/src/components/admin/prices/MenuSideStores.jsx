...
import { useAddStoreMutation, useDeleteStoreMutation, useGetStoresQuery } from '../../../slices/stores/storeApiSlice';
...
const MenuSide = () => {
    ...
    const [addShppingList, { data: addedStore, isSuccess: isSuccessAddStore }] = useAddStoreMutation();
    const [removeStore, { isSuccess: isSuccessRemove,data:datadeleted}] = useDeleteStoreMutation();
    useEffect(() => {
